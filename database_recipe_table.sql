...
-- Listage de la structure de table recipe_suzanne. recipe
...
-- Listage des données de la table recipe_suzanne.recipe : ~11 rows (environ)
INSERT INTO `recipe` (`id_recipe`, `recipe_name`, `preparation_time`, `instructions`, `id_category`) VALUES
	...
	(6, 'cookies_maison', 25, 'Détailler le chocolat en pépites. Préchauffer le four à 180°C (thermostat 6). Dans un saladier, mettre 75 g de beurre, le sucre, l\'oeuf entier, la vanille et mélanger le tout avec une cuillère en bois.  Ajouter petit à petit la farine mélangée à la levure, le sel et le chocolat. Avec une feuille de papier essuie-tout, beurrer une plaque allant au four et former les cookies sur la plaque. Pour former les cookies, utiliser 2 cuillères à soupe et faire des petits tas espacés les uns des autres; ils grandiront à la cuisson. Enfourner pour 10 minutes de cuisson.  ', 3),
